...
void SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_46(void)
{
  if(0UL == Counter_46)
  {
    SuspendAllInterrupts();
...
void SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_47(void)
{
  if(0UL == Counter_47)
  {
    SuspendAllInterrupts();
...
void SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_48(void)
{
  if(0UL == Counter_48)
  {
    SuspendAllInterrupts();
...
void SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_49(void)
{
  if(0UL == Counter_49)
  {
    SuspendAllInterrupts();
...
void SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_67(void)
{
  if(0UL == Counter_67)
  {
    SuspendAllInterrupts();
...
void SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_68(void)
{
  if(0UL == Counter_68)
  {
    SuspendAllInterrupts();
...
void SchM_Enter_Pwm_PWM_EXCLUSIVE_AREA_69(void)
{
  if(0UL == Counter_69)
  {
    SuspendAllInterrupts();
...
void SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_46(void)
{
  Counter_46--;
  if (0UL == Counter_46)
  {
...
void SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_47(void)
{
  Counter_47--;
  if (0UL == Counter_47)
  {
...
void SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_48(void)
{
  Counter_48--;
  if (0UL == Counter_48)
  {
...
void SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_49(void)
{
  Counter_49--;
  if (0UL == Counter_49)
  {
...
void SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_67(void)
{
  Counter_67--;
  if (0UL == Counter_67)
  {
...
void SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_68(void)
{
  Counter_68--;
  if (0UL == Counter_68)
  {
...
void SchM_Exit_Pwm_PWM_EXCLUSIVE_AREA_69(void)
{
  Counter_69--;
  if (0UL == Counter_69)
  {
