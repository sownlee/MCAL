...
{
    Dio_Ip_Init(para_DioIpcConfig_ptr->DioIpConfig_ptr);
}
 ...
 *
 *  @arg            const Dio_Ipc_ConfigType *
 *  @param[in]      Dio_Ipc_EachConfigType            Config structure to be set.
 *
 *  @return         None     
 *  @retval         None
 *
...
{
    Dio_Ip_SetDioConfig(para_DioConfig_ptr);
}
...
{
    return Dio_Ip_AsyncSend(para_DioConfig_ptr, para_Buffer_ptr, para_BufferSize_u32);
}
...
{
    return Dio_Ip_AsyncReceive(para_DioConfig_ptr, para_Buffer_ptr, para_BufferSize_u32);
}
...
{
    return Dio_Ip_SyncSend(para_DioConfig_ptr, para_Buffer_ptr, para_BufferSize_u32);
}
...
{
    return Dio_Ip_SyncReceive(para_DioConfig_ptr, para_Buffer_ptr, para_BufferSize_u32);
}
...
{
    return Dio_Ip_ChangeBaudrate(para_DioConfig_ptr, para_Baudrate_e);
}
...
{
    return Dio_Ip_Abort(para_DioConfig_ptr);
}
...
{
    return Dio_Ip_DeInit(para_DioConfig_ptr);
}
