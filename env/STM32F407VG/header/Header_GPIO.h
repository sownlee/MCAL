...
typedef struct
{
	__O uint32_t MODER;   /* GPIO port mode register */
	__O uint32_t OTYPER;  /* GPIO port output type register */
	__O uint32_t OSPEEDR; /* GPIO port output speed register */
	__O uint32_t PUPDR;   /* GPIO port pull-up/pull-down register */
	__O uint32_t IDR;     /* GPIO port input data register (GPIOx_IDR) */
	__O uint32_t ODR;     /* GPIO port output data register (GPIOx_ODR) */
	__O uint32_t BSRR;    /* GPIO port bit set/reset register (GPIOx_BSRR) */
	__O uint32_t LCKR;    /* GPIO port configuration lock register (GPIOx_LCKR) */
	__O uint32_t AFR[2];  /* AFR[0] : GPIO alternate function low register, AF[1] : GPIO alternate function high register*/
}GPIO_RegDef_t;
